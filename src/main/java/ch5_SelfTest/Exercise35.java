...
public class Exercise35 extends JPanel {
    ...
    private void drawFaceSansMouth(Graphics g, int pos,Color c)
    {
        g.setColor(c);
...
//Add text:
    ...
    public static void main(String[] args) {
        Exercise35 watchPanel=new Exercise35();
