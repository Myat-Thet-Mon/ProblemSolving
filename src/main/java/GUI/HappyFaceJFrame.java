package GUI;
/*
Give the declaration for a variable called count of type int . The variable
...
//Draw face outline:
    //    canvas.drawLine(100,100, 600, 100);
       // canvas.drawLine(100,100, 100, 400);

     //   canvas.drawOval(100, 100, 500, 300);

      //  canvas.drawOval(0, 0, 100, 200);
