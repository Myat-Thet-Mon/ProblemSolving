...
class Species3 {
    ...
    public boolean equals(ch6_SelfTest.Species3 otherObject)
    {
...
public class Exercise37 {
    public static void main(String[] args) {
        Species3 species=new Species3();
        species.readInput();
        species.setSpecies("Mg");
        species.writeOutput();
        //if method had same name then the parameter should not be the same
    }
}
